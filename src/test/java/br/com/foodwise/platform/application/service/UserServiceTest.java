...
class UserServiceTest {
    ...
    void createUser_ShouldCallCreateUserUseCase() {
        when(createUserUseCase.execute("test@example.com", "password", UserType.CUSTOMER)).thenReturn(user);

        User createdUser = userService.createUser("test@example.com", "password", UserType.CUSTOMER);
