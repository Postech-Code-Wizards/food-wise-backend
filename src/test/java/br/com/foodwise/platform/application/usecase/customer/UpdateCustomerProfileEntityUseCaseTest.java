...
class UpdateCustomerProfileEntityUseCaseTest {
    ...
    void shouldUpdateCustomerProfileSuccessfully() {
        ...
        assertEquals(customerProfileEntity.getAddressEntity(), customerProfile.getAddressEntity());
        assertEquals(customerProfileEntity.getPhoneEntity(), customerProfile.getPhoneEntity());
